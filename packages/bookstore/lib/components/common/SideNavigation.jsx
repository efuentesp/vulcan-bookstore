    ...
    return (
      <div className={classes.root}>
        <List>
          ...
          <ListItem button onClick={() => { browserHistory.push('/productcategoriesscreen'); }}>
            <ListItemIcon>
            	<VectorSquare/>
            </ListItemIcon>
            <ListItemText inset primary="Category List"/>
          </ListItem>
          <ListItem button onClick={() => { browserHistory.push('/shoppingcartscreen'); }}>
            <ListItemIcon>
            	<VectorSquare/>
            </ListItemIcon>
